...
⠀⠉⠉⠉⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀"""
    ...
    print("     python netherite-pickaxe <repo_path> [--substring] [--ignore-null] [--include-all] [--not-repo]")
    print()
    ...
    print("     --substring      Search for substring keyword matches instead of exact.")
    ...
    print("     --not-repo       Will do a file search only, for non git initialised folder directorys.")
    print()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--substring", action="store_true", help="Search for substring keyword matches instead of exact.")
    ...
    parser.add_argument("--not-repo", action="store_true", help="Search directory for keywords that isnt a git folder.")
